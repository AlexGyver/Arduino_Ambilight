...
*/
//----------------------НАСТРОЙКИ-----------------------
#define NUM_LEDS 100          // число светодиодов в ленте
#define DI_PIN 2            // пин, к которому подключена лента

#define start_flashes 0      // проверка цветов при запуске (1 - включить, 0 - выключить)
#define count_seconds_for_off_led 60 //Количество секунд по прошествии которого лента выключится (всем пикселям будет задан ) - таймер идет если нет связи с компом (например отключена подсветка)
